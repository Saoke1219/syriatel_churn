...
![classification_report_tuned](https://github.com/Saoke1219/syriatel_churn/assets/144167777/07a9378a-ba17-42ab-b025-8e16e7ce37e4)

Accuracy (0.95105):An accuracy of 0.95105 suggests that the model correctly predicted the churn status of approximately 95.1% of the customers in the dataset. This indicates a high overall correctness of the model's predictions.A F1 score of 0.73684 indicates a balanced evaluation of the model's accuracy in predicting both churn and non-churn customers.A recall of 0.59756 means that the model correctly identified approximately 59.8% of the churn cases.A precision of 0.96078 suggests that when the model predicts a customer will churn, it is correct approximately 96.1% of the time.This high precision score indicates that the model is very good at minimizing false positive predictions, which is desirable in many scenarios.
...
After modeling Random Forest Classifier was identified as the best model that best predicts likelihood of a customer to churn with a percentage 96.1% precision rate.
